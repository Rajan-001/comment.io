...
export const Description = (props: Props) => {
  return (
   <div className="flex flex-col px-12 py-16 items-center bg-gradient-to-b from-white via-slate-50 to-slate-100 text-slate-800">
  {/* Header */}
  ...
  {/* Description */}
  <p className="max-w-3xl text-center text-lg text-slate-600 mb-12 leading-relaxed">
